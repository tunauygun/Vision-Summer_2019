...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__blur_radius = 1.8018018018018012

        self.blur_output = None

        self.__hsv_threshold_input = self.blur_output
        self.__hsv_threshold_hue = [0.0, 26.416382252559714]
        self.__hsv_threshold_saturation = [98.60611510791367, 191.90273037542661]
        self.__hsv_threshold_value = [158.22841726618705, 255.0]

        self.hsv_threshold_output = None

        self.__find_blobs_input = self.hsv_threshold_output
        self.__find_blobs_min_area = 2.0
